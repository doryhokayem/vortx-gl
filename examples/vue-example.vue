...
const graphData = ref({
  nodes: [
    {
      data: { id: "1", label: "CEO", color: "#ff4757", width: 80, height: 80 },
      position: { x: 2500, y: 2400 },
    },
    {
      data: { id: "2", label: "CTO", color: "#2ed573", width: 60, height: 60 },
      position: { x: 2300, y: 2600 },
    },
    {
      data: { id: "3", label: "CFO", color: "#1e90ff", width: 60, height: 60 },
